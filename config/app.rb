...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'quick-calc.com'
  config.app_name = 'Quick_calc'
  config.mailer.from = 'Quick_calc <no-reply@quick-calc.com>'
  ...
  #
  config.app_secret = 'qEXSKena66PXO7Hq_Ntfrgpdiv31sv3N1ml1lJC_qMoDTPWovjXOQ-PBwq7OLBglP5U'
